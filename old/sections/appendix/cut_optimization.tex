...
A comparison between the hand-chosen and best combination of values for the cuts is reported in Tab. \ref{tab:best_parameters}. Among these, it is interesting to note the significant change in the maximum Y for the vertex position, where the optimized cut removes ~2 meters from the top. This makes sense, considering that neutrinos are expected to interact more often in the lower section of the detector.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/direction_z_max_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/direction_z_max_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_fifteenth10cm_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_fifteenth10cm_min_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_fifth10cm_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_fifth10cm_min_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_first10cm_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/energy_first10cm_min_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/num_pf_particles_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/num_pf_particles_min_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/roi_z_size_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/roi_z_size_min_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/roi_z_vertex_distance_max_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/roi_z_vertex_distance_max_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/tail_length_density_max_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/tail_length_density_max_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/vertex_y_max_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/vertex_y_max_total_events.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/vertex_z_min_score_efficiency_purity_significance.png}\\
    \includegraphics[width=0.69\linewidth]{sections/appendix/cut_optimization/vertex_z_min_total_events.png}
