...
% \hline
% \textbf{Run ID} & \textbf{Wobbling Configuration} & \textbf{PoT Integral} $\mathbf{(\times  10^{16})}$ & \textbf{Runtime (h)} & \textbf{Duty Cycle Time (h)} \\
% \hline
% 029424 & GIF++   & 1.9380 & 28.0480 & 7.6400  \\
% 029425 & GIF++   & 1.9989 & 33.1793 & 8.4560  \\
% 029917 & w133    & 0.3337 & 5.4400  & 1.5013  \\
...
% \end{tabular}%
% }
% \caption{Summary of data collected with the ADC Simple Window trigger algorithm, as described in section \ref{chap:trigger}. Run 031036 was recorded in absence of beam to serve as an estimate of the cosmic background.}
